				...
				<div class="col-12">
					<main class="main">
						...
						<section class="section section__form">
							<form action="../../php/bungalows/createBungalow.php" method="post" class="form" enctype="multipart/form-data">
								...
								<div class="input-container">
									...
									<input type="number" name="capacity" id="capacity" class="input-box" />
								</div>

                                <div class="input-container">
                                    <label for="pricePerNight">Price per night</label>
                                    <input type="number" step=".1" name="pricePerNight" id="pricePerNight" class="input-box"></input>
                                </div>
                            ...
                            <button class="button col-2 align-self-end" type="submit" name="submit">Add bungalow</button>
						</form>
						</section>
					</main>
				</div>
