				...
				<div class="col-12">
					<main class="main">
						...
						<section class="section section__form">
							<form action="../../php/customers/createCust.php" method="post" class="form">
								...
								<div class="input-container">
									...
									<input type="text" name="phoneNumber" id="phoneNumber" class="input-box" />
								</div>
                                ...
                                <div class="input-container">
									...
									<input type="text" name="nationality" id="nationality" class="input-box" />
								</div>

							<button class="button col-2 align-self-end">Add</button>
						</form>
						</section>
					</main>
				</div>
