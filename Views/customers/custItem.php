...
<html lang="en">
	...
	<?php
        ...
        $id = $_GET['id'];
		$selectedCustomer = getCustomerById($id);
	?>
				...
				<div class="col-12">
					<main class="main">
                        ...
                        <section class="item-section section mt-5">
                            <a class="go-back" href="customers.php">
                            ...
                            <div class="item-section__overview section-box section-margin flex-md-row">
                                <div class="item-section__info col-12 col-md-7 justify-content-between">
                                    <h3 class="item-section__title">
                                        <?php echo $selectedCustomer['customerName']. " " . $selectedCustomer['customerSurname'] ?>
                                    </h3>
                                    <div class="item-section__reservation--info d-flex gap-4">
                                        <div>
                                            <p class="promo ">email address</p>
                                            <p class="promo-title mt-2">$ <?php echo $selectedCustomer['customerEmail'] ?></p>
                                        </div>
                                    </div>
                                            ...
                                            <div class="overview-card__stats">
                                                <div class="overview-card__stats--box">
                                                    ...
                                                    <p class="overview-card__stats--number">
                                                        <?php echo $selectedCustomer['customerPhoneNumber'] ?>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="overview-card col-9 col-sm-7 col-md-8 col-lg-5 col-xxl-4 mt-3">
                                            <div class="overview-card__stats">
                                                <div class="overview-card__stats--box">
                                                    ...
                                                    <p class="overview-card__stats--number">
                                                        <?php echo $selectedCustomer['nationality'] ?>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="item-section__actions mt-3">
                                        <form class="d-flex align-items-center justify-content-center" method="get">
                                            <input type="hidden" name="id" value="<?php echo $selectedCustomer['id']; ?>" />
                                                <a href="editEmployee.php?id=<?php echo $selectedCustomer['id']; ?>">
                                                    <img src="../../assets/icons/edit.svg" alt="" />
                                                </a>
                                        </form>
                                        <form class="d-flex align-items-center justify-content-center" action="../../php/customers/deleteCustomer.php" method="post">
                                            <input type="hidden" name="deleteReservation" value="<?php echo $selectedCustomer["id"]; ?>" />
