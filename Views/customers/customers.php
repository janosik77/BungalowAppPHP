...
<html lang="en">
  ...
  <?php
    ...
    if(isset($_POST['search'])){
      ...
      $customers = searchCustomers($searchQuery);
    }
    else if(isset($_POST['sort']) && $_POST['sort'] !== 'all'){
      $sortQuery = $_POST['sort'];
      $customers = sortCustomers($sortQuery);
    } else if(isset($_POST['sort']) && $_POST['sort'] === 'all'){
                    ...
                    <div class="table-actions mb-5">
                      ...
                      <form method="post" class="table-actions__sort">
                        <select name="sort" id="sort" class="input-box">
                          ...
                          <option value="nationality"<?php echo $sortQuery === 'nationality' ? 'selected' : '' ?>>Nationality</option>
                          <option value="name"<?php echo $sortQuery === 'name' ? 'selected' : '' ?>>Name</option>
                          <option value="street"<?php echo $sortQuery === 'street' ? 'selected' : '' ?>>Address</option>
                        </select>
                        <button class="button">Sort</button>
                      </form>
                    </div>
                    <table class="table reservations-table customers-table">
                      <thead>
                        <tr>
                            ...
                            <tr>
                              <td>
                                <div class="reservations-table__guest">
                                  <span class="name">
                                    <?php echo $customer['customerName'] . " " . $customer['customerSurname']; ?>
                                  </span>
                                  <span class="email">
                                    <?php echo $customer['customerEmail']; ?>
                                  </span>
                                </div>
                              </td>
                              <td>
                                <div class="customers-table__phone">
                                  <?php echo $customer['customerPhoneNumber']; ?>
                                </div>
                              </td>
                              <td>
                                <div class="customers-table__address">
                                  <span class="street">
                                    <?php echo $customer['customerStreet'] . " " . $customer['customerStreetNumber']; ?>
                                  </span>
                                  <span class="city"> 
                                    <?php echo $customer['customerCity'] . " " . $customer['customerPostalCode']; ?>
                                  </span>
                                  <span class="country">
                                    <?php echo $customer['customerCountry']; ?>
                                  </span>
                                </div>
											        </td>
                              <td>
                                <div class="employees-table__nationality">
                              ...
                              <td>
                                <div class="reservations-table__actions">
                                  ...
                                  <form class="d-flex align-items-center justify-content-center" method="get">
                                    <input type="hidden" name="id" value="<?php echo $customer['id']; ?>" />
                                    <a href="custItem.php?id=<?php echo $customer['id']; ?>">
                                      <img src="../../assets/icons/view.svg" alt="View icon" />
                                    </a>
                                  </form>

                                  <form class="d-flex align-items-center justify-content-center" action="../../php/customers/deleteCustomer.php" method="post">
                                    <input type="hidden" name="deleteCustomer" value="<?php echo $customer["id"]; ?>" />
