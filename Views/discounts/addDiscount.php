				...
				<div class="col-12">
					<main class="main">
						...
						<section class="section section__form">
							<form action="../../php/discounts/createDiscount.php" method="post" class="form">
                            ...
                            <div class="input-container">
									...
									<select name="bungalow" id="bungalow" class="input-box">
										...
										foreach ($bungalows as $bungalow) {
											echo "<option value='{$bungalow['id']}'>{$bungalow['name']}</option>";
										}
										?>
									</select>
							</div>
                            ...
                            <div class="form-box d-flex justify-content-between row">
                                <div class="input-container col-6 ps-0">
                                    ...
                                    <input type="date" name="validFrom" id="validFrom" class="input-box" />
                                </div>

                                <div class="input-container col-6 pe-0">
                                    <label for="validTo">Valid to</label>
                                    <input type="date" name="validTo" id="validTo" class="input-box" />
                                </div>
                            </div>

                            <div class="input-container">
                                    <label for="promoName">Discount name</label>
                                    <input type="text" name="promoName" id="promoName" class="input-box" />
                            </div>

                            <div class="input-container">
                                    <label for="discount">Discount</label>
                                    <input type="number" name="discount" id="discount" class="input-box" placeholder="in %" />
                            </div>

                            <div class="input-container">
                                    <label for="description">Description</label>
                                    <input type="text" name="description" id="description" class="input-box" />
                            </div>
