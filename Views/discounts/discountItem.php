...
<html lang="en">
	...
	<?php
        ...
        $id = $_GET['id'];
		$selectedDiscount = getDiscountById($id);
        $discountBungalow = getBungalowById($selectedDiscount['idBungalow']);
	?>
			...
			<div class="wrapper d-flex justify-content-between navbar-container container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
					<div class="navbar-nav">
						...
						<a class="nav-link" href="../bungalows/bungalows.php">Bungalow</a>
				...
				<div class="col-12">
					<main class="main">
                        ...
                        <section class="item-section section mt-5">
                            <a class="go-back" href="discounts.php">
                            ...
                            <div class="item-section__overview section-box section-margin flex-md-row">
                                <div class="item-section__info col-12 col-md-7 justify-content-between">
                                            ...
                                            <div class="overview-card__stats">
                                                <div class="overview-card__stats--box">
                                                    ...
                                                    <p class="overview-card__stats--number">
                                                        <?php echo $selectedDiscount['discount'] ?>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="item-section__promo mt-3">
                                        <p class="promo">bungalows</p>
                                        <div class="item-section__promo--igloos my-3 d-flex gap-5 flex-wrap">
                                            <div class="item-section__promo--bungalow-box">
                                                <?php echo $discountBungalow['name'] ?>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item-section__actions mt-3">
                                        <form class="d-flex align-items-center justify-content-center" method="get">
                                            <input type="hidden" name="id" value="<?php echo $selectedDiscount['id']; ?>" />
                                                <a href="editDiscount.php?id=<?php echo $selectedDiscount['id']; ?>">
                                                    <img src="../../assets/icons/edit.svg" alt="" />
                                                </a>
                                        </form>
                                        <form class="d-flex align-items-center justify-content-center" action="../../php/discounts/deleteDiscount.php" method="post">
                                            <input type="hidden" name="deleteReservation" value="<?php echo $selectedDiscount["id"]; ?>" />
