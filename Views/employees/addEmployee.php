				...
				<div class="col-12">
					<main class="main">
						...
						<section class="section section__form">
							<form action="../../php/employees/createEmployee.php" method="post" class="form" enctype="multipart/form-data">
								...
								<div class="form-box d-flex justify-content-between row">
                                    ...
                                    <div class="input-container col-6 pe-0">
									    ...
									    <input type="text" name="surname" id="surname" class="input-box" />
								    </div>
                                </div>
								...
								<div class="input-container">
									    ...
									    <input type="text" name="phoneNumber" id="postalCode" class="input-box" />
								</div>

								<div class="input-container">
									<label for="street">Street</label>
									<input type="text" name="street" id="street" class="input-box" />
								</div>

                                <div class="form-box d-flex justify-content-between row">
                                    <div class="input-container col-6 ps-0">
                                        <label for="streetNumber">Street number</label>
                                        <input type="text" name="streetNumber" id="streetNumber" class="input-box" />
                                    </div>

                                    <div class="input-container col-6 pe-0">
									    <label for="houseNumber">House number</label>
									    <input type="text" name="houseNumber" id="houseNumber" class="input-box" />
								    </div>
                                </div>
                                ...
                                <div class="form-box d-flex justify-content-between row">
                                    ...
                                    <div class="input-container col-6 pe-0">
									    ...
									    <input type="text" name="postalCode" id="postalCode" class="input-box" />
								    </div>
                                </div>
								...
								<div class="input-container">
									...
									<select name="employeeRole" id="employeeRole" class="input-box">
										...
										foreach ($employeeRoles as $employeeRole) {
											echo "<option value='{$employeeRole['id']}'>{$employeeRole['roleName']}</option>";
										}
										?>
							...
							<button class="button col-2 align-self-end" type="submit" name="submit">Add</button>
						</form>
						</section>
					</main>
				</div>
