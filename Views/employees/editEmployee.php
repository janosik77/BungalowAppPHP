...
<html lang="en">
	...
	<?php
        ...
        if(isset($_GET['id'])){
            ...
            $employeeStreet = $employee['employeeStreet'];
            $employeeStreetNumber = $employee['employeeStreetNumber'];
            $employeeHouseNumber = $employee['employeeHouseNumber'];
			...
			<div class="wrapper d-flex justify-content-between navbar-container container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
					<div class="navbar-nav">
						...
						<a class="nav-link active" href="../employees/employees.php">Employees</a>
				...
				<div class="col-12">
					<main class="main">
						...
						<section class="section section__form">
							<form action="../../php/employees/updateEmployee.php" method="post" class="form" enctype="multipart/form-data">
								...
								<div class="form-box d-flex justify-content-between row">
                                    <div class="input-container col-6 ps-0">
                                        ...
                                        <input type="text" name="name" id="name" class="input-box" value="<?php echo $employeeName ?>" />
                                    </div>

                                    <div class="input-container col-6 pe-0">
									    <label for="surname">Surname</label>
									    <input type="text" name="surname" id="surname" class="input-box" value="<?php echo $employeeSurname ?>" />
								    </div>
                                </div>

								<div class="input-container">
									<label for="email">Email address</label>
									<input type="email" name="email" id="email" class="input-box" value="<?php echo $employeeEmail ?>" />
								</div>

								<div class="input-container">
									    <label for="phoneNumber">Phone number</label>
									    <input type="text" name="phoneNumber" id="postalCode" class="input-box" value="<?php echo $employeePhoneNumber ?>" />
								</div>

								<div class="input-container">
									<label for="street">Street</label>
									<input type="text" name="street" id="street" class="input-box" value="<?php echo $employeeStreet ?>" />
								</div>

                                <div class="form-box d-flex justify-content-between row">
                                    <div class="input-container col-6 ps-0">
                                        <label for="streetNumber">Street number</label>
                                        <input type="text" name="streetNumber" id="streetNumber" class="input-box" value="<?php echo $employeeStreetNumber ?>" />
                                    </div>

                                    <div class="input-container col-6 pe-0">
									    <label for="houseNumber">House number</label>
									    <input type="text" name="houseNumber" id="houseNumber" class="input-box" value="<?php echo $employeeHouseNumber ?>" />
								    </div>
                                </div>

                                <div class="input-container">
									<label for="city">City</label>
									<input type="text" name="city" id="city" class="input-box" value="<?php echo $employeeCity ?>" />
								</div>

                                <div class="form-box d-flex justify-content-between row">
                                    <div class="input-container col-6 ps-0">
                                        <label for="country">Country</label>
                                        <input type="text" name="country" id="country" class="input-box" value="<?php echo $employeeCountry ?>" />
                                    </div>

                                    <div class="input-container col-6 pe-0">
									    <label for="postalCode">Postal code</label>
									    <input type="text" name="postalCode" id="postalCode" class="input-box" value="<?php echo $employeePostalCode ?>" />
								    </div>
                                </div>

								<div class="input-container">
									<label for="paymentMethod">Select employee role</label>
									<select name="employeeRole" id="employeeRole" class="input-box">
										<?php
										foreach ($employeeRoles as $employeeRole) {
                                            $selected = $employeeRole['id'] == $employee['idEmployeeRole'] ? "selected" : "";
											echo "<option value='{$employeeRole['id']}' {$selected}>{$employeeRole['roleName']}</option>";
										}
										?>
								...
								<?php if (!empty($imagePath)): ?>
									<p>Current Image: <strong><?php echo str_replace('assets/images/', '', $imagePath); ?></strong></p>
									<img src="<?php echo htmlspecialchars("../../".$imagePath); ?>" alt="Current Image" width="100" />
								<?php endif; ?>
							</div>
