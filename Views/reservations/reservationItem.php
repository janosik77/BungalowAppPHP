				...
				<div class="col-12">
					<main class="main">
                        ...
                        <section class="item-section section mt-5">
                            <a class="go-back" href="reservations.php">
                                <img src="../../assets/icons/arrow-left.svg" alt="Go back" />
                            </a>

                            <div class="heading section-margin">
                                <h1 class="mt-4">Reservation <?php echo $selectedReservation["id"] ?></h1>
                            </div>

                            <div class="item-section__overview section-box section-margin flex-md-row">
                                <div class="item-img col-12 col-md-5 col-lg-4">
                                    <img src="<?php echo "../../".$selectedReservation['bungalowPath'] ?>" alt="" />
                                </div>
                                <div class="item-section__info col-12 col-md-7 justify-content-between">
                                    <h3 class="item-section__title">
                                        <?php echo $selectedReservation['bungalowName'] ?>
                                    </h3>
                                    <div class="item-section__reservation--info d-flex gap-4 justify-content-between">
										<div class="d-flex gap-3 align-items-center w-100  justify-content-between">
											<div>
												<p class="promo">Amount</p>
												<p class="promo-title mt-2">$ <?php echo $selectedReservation['amount'] ?></p>
											</div>
											<div>
												<span class="<?php echo "status status__".$selectedReservation['reservationStatus']. " me-3" ?>">
													<?php echo $selectedReservation['reservationStatus'] ?>
												</span>
											</div>
										</div>                                       
                                    </div>
                                            ...
                                            <div class="overview-card__stats">
                                                <div class="overview-card__stats--box">
                                                    ...
                                                    <p class="overview-card__stats--number">
                                                        <?php echo $selectedReservation['userName'] . " " . $selectedReservation['userSurname'] ?>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="overview-card col-9 col-sm-7 col-md-8 col-lg-5 col-xxl-4 mt-3">
                                            <div class="overview-card__stats">
                                                <div class="overview-card__stats--box">
                                                    ...
                                                    <p class="overview-card__stats--number">
                                                        <?php echo $selectedReservation['userPhoneNumber'] ?>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="overview-card col-9 col-sm-7 col-md-8 col-lg-5 col-xxl-4 mt-3">
                                            <div class="overview-card__stats">
                                                <div class="overview-card__stats--box">
                                                    ...
                                                    <p class="overview-card__stats--number">
                                                        <?php echo $selectedReservation['userEmail'] ?>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
									...
									<form class="d-flex " action="../../php/reservations/exportReservationItem.php" method="get">
											<input type="hidden" name="exportReservationItem" value="<?php echo $selectedReservation["id"]; ?>" />
											<button class="svg-button" href="">
												<img src="../../assets/icons/export.svg" alt="export reservation" />
                                            </button>
										</form>
                                        <form class="d-flex align-items-center justify-content-center" action="../../php/reservations/delReservation.php" method="post">
                                            <input type="hidden" name="delReservation" value="<?php echo $selectedReservation["id"]; ?>" />
                                            <button class="svg-button" href="">
                                        ...
                                        <form class="d-flex align-items-center justify-content-center" method="get">
                                            <input type="hidden" name="id" value="<?php echo $selectedReservation['id']; ?>" />
                                                <a href="editReservation.php?id=<?php echo $selectedReservation['id']; ?>">
